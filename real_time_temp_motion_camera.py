...
@app.route('/')
def index():
    return render_template('index_original_working.html', motion_detected=motion_detected, body_temp_fahrenheit=body_temp_fahrenheit, ambient_temp_celsius=ambient_temp_celsius)
